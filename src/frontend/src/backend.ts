...
import type { Bill as _Bill, ExternalBlob as _ExternalBlob, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addShopImage(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addShopImage(arg0, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addUPIQRCode(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addUPIQRCode(arg0, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createBill(arg0: string, arg1: string, arg2: Principal, arg3: bigint, arg4: ExternalBlob): Promise<Bill> {
        if (this.processError) {
            try {
                const result = await this.actor.createBill(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg4));
    ...
    async getAvailableShopsByCollege(arg0: string): Promise<Array<Shop>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableShopsByCollege(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getShopsByCollege(arg0: string): Promise<Array<Shop>> {
        if (this.processError) {
            try {
                const result = await this.actor.getShopsByCollege(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Bill_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Bill): Promise<Bill> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        total: value.total,
        paymentStatus: from_candid_variant_n13(_uploadFile, _downloadFile, value.paymentStatus),
        shopId: value.shopId,
        upiQrUrl: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.upiQrUrl),
        userId: value.userId,
